...
<nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
    <div class="sidebar-inner px-4 pt-3">
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            <li class="nav-item">
                <a href="" class="nav-link d-flex align-items-center">
                    <span class="sidebar-icon">
                        <img src="../../asset/img/logo.png" height="20" width="20" alt="Volt Logo">
                    </span>
                    <span class="mt-1 ms-1 sidebar-text">GHK</span>
                </a>
            </li>
            ...
            <!-- Quản lý vật tư -->
            <li class="nav-item">
                <a href="dashboard.php?controller=vattu" class="nav-link">
                    <span class="sidebar-icon">
                    ...
                    <span class="sidebar-text">Vật tư</span>
                </a>
            </li>
            <!-- Quản lý nhà sản xuất -->
            <li class="nav-item">
                <a href="dashboard.php?controller=nsx" class="nav-link">
                    <span class="sidebar-icon">
                        <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span class="sidebar-text">Nhà sản xuất</span>
                </a>
            </li>
            <!-- Quản lý số điện thoại -->
            <li class="nav-item">
                <a href="dashboard.php?controller=sdtnsx?action=sdt" class="nav-link">
                    <span class="sidebar-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-xs me-2" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <span class="sidebar-text">SĐT nhà sản xuất</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a href="dashboard.php?controller=taikhoan" class="nav-link">
                    <span class="sidebar-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-xs me-2" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="nav-item">
                <a href="dashboard.php?controller=kholuutru" class="nav-link">
                    <span class="sidebar-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-xs me-2" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round"
