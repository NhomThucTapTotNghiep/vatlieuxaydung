...
<div class="py-4">
    <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
        <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
            ...
            <li class="breadcrumb-item">
                <a href="dashboard.php?controller=nsx&action=update">Cập nhật Nhà sản xuất</a>
            </li>
        </ol>
    </nav>
    <div class="dropdown">
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h4 class="mt-2 font-weight-bold text-primary float-left">Cập nhật nhà sản xuất</h6>
    </div>
    <div class="row">
...
<<<<<<< HEAD
                    <form method="POST" action="dashboard.php?controller=nsx&action=updateNSX" class="needs-validation"
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input class="form-control" type="text" id="" name="MaNSX" placeholder=""
                                value="<?php echo $item['MaNSX'] ?>" readonly />
                        </div>
                        <div class="form-group mb-4">
                            <label for="}" class="col-form-label">Tên nhà sản xuất: </label>
                            <input class="form-control" type="text" id="" name="TenNSX" placeholder="Tên nhà sản xuất"
                                value="<?php echo $item['TenNSX'] ?>" required />
                            <div class="invalid-feedback">Không được bỏ trống</div>
                        </div>
                        <div class="form-group mb-4">
                        <label for="}" class="col-form-label">Địa chỉ: </label>
                                <input class="form-control" type="text" id="" name="DiaChi" placeholder="Địa chỉ" value="<?php echo $item['DiaChi'] ?>" />
                            <div class="invalid-feedback">Không được bỏ trống</div>
                        </div>
