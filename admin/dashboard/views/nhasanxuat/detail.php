...
<div class="py-4">
    <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
        <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
            ...
            <li class="breadcrumb-item">
                <a href="dashboard.php?controller=nsx&action=update">Chi tiet Nhà sản xuất</a>
            </li>
        </ol>
    </nav>
    <div class="dropdown">
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h4 class="mt-2 font-weight-bold text-primary float-left">Chi tiet nhà sản xuất</h6>
    </div>
    <div class="row">
                ...
                <div class="card-body">
                    <form method="POST" action="dashboard.php?controller=nsx&action=updateNSX">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input class="form-control" readonly type="text" id="" name="TenNSX" placeholder="" value="<?php echo $item['TenNSX'] ?>" />
                            <!-- <div class="invalid-feedback"><?php $message ?></div> -->
                        </div>
                        <div class="row">
                            <div class="col">
                                <label for="}" class="col-form-label">Địa chỉ: </label>
                                <input class="form-control" readonly type="text" id="" name="DiaChi" placeholder="" value="<?php echo $item['DiaChi'] ?>" />
                                <!-- <div class="invalid-feedback"><?php $message ?></div> -->
                            </div>
                        </div>
