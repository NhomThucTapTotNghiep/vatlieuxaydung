    ...
    <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
        <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
            ...
            <li class="breadcrumb-item">
                <a href="dashboard.php?controller=nhanvien">Danh sách khách hàng</a>
            </li>
            <li class="breadcrumb-item">
                <a href="dashboard.php?controller=nhanvien&action=addsdt">Thêm số điện thoại</a>
            </li>
        </ol>
    </nav>
    <div class="dropdown">
...
<div class="card shadow mb-4">
    ...
    <div class="row">
        <div class="col-12 mb-4 mx-auto">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="dashboard.php?controller=nhanvien&action=addSdt"
                        class="needs-validation" novalidate>
                        <div class="form-group mb-4">
                            <label for="TenKH">Chọn khách hàng:</label>
                            <select style="color: black;" name="maNV" id="maNV" class="form-control">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input class="form-control" type="tel" id="SDTNV" name="SDTNV" placeholder="Số điện thoại"
